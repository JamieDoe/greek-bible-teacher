  ...
  return (
    ...
    >
      <CheckboxPrimitive.Indicator
        ...
        className="grid place-content-center text-current transition-none [&>svg]:size-4 [&>svg]:stroke-[2.6]"
      >
        <CheckIcon />
      </CheckboxPrimitive.Indicator>
    </CheckboxPrimitive.Root>
